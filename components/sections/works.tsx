...
import { CaseStudyBody, type CaseStudyContent } from "@/components/sections/helpers/case-study";

const WORKS: { id: string; title: string; subtitle: string; study: CaseStudyContent }[] = [
  {
    id: "work-01",
    title:
      "Work 01: AI Image Analysis System for a Major Railway Company",
...
export default function Works() {
  return (
    <div className="pb-2">
      <PageIntro>
        <Paragraph>
          Case studies from my work at Corpy & Co., Inc. and as a freelancer across
          AI, manufacturing, and autonomous-driving projects. Confidential client work
          limits what can be shared; each entry covers my role, scope, and outcomes.
        </Paragraph>
      </PageIntro>
